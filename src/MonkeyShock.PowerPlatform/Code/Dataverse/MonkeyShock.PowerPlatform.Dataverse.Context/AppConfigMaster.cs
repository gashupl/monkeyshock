...
namespace MonkeyShock.PowerPlatform.Dataverse.Context
{
	...
	public partial class AppConfigMaster : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<MonkeyShock.PowerPlatform.Dataverse.Context.AppConfigInstance> appconfigmaster_appconfiginstance
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<MonkeyShock.PowerPlatform.Dataverse.Context.AppConfigInstance>("appconfigmaster_appconfiginstance", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appconfigmaster_appconfiginstance");
				this.SetRelatedEntities<MonkeyShock.PowerPlatform.Dataverse.Context.AppConfigInstance>("appconfigmaster_appconfiginstance", null, value);
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_appconfigmaster_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_appconfigmaster_createdby", null);
			}
		}
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_appconfigmaster_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_appconfigmaster_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfigmaster_createdonbehalfby");
				this.SetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_appconfigmaster_createdonbehalfby", null, value);
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_appconfigmaster_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_appconfigmaster_modifiedby", null);
			}
		}
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_appconfigmaster_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_appconfigmaster_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfigmaster_modifiedonbehalfby");
				this.SetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_appconfigmaster_modifiedonbehalfby", null, value);
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.Organization organization_appconfigmaster
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.Organization>("organization_appconfigmaster", null);
			}
		}
