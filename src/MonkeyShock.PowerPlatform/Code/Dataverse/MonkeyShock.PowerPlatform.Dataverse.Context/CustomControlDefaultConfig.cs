...
namespace MonkeyShock.PowerPlatform.Dataverse.Context
{
	...
	public partial class CustomControlDefaultConfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.Organization customcontroldefaultconfig_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.Organization>("customcontroldefaultconfig_organization", null);
			}
		}
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_customcontroldefaultconfig_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_customcontroldefaultconfig_createdby", null);
			}
		}
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_customcontroldefaultconfig_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_customcontroldefaultconfig_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontroldefaultconfig_createdonbehalfby");
				this.SetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_customcontroldefaultconfig_createdonbehalfby", null, value);
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_customcontroldefaultconfig_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_customcontroldefaultconfig_modifiedby", null);
			}
		}
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_customcontroldefaultconfig_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_customcontroldefaultconfig_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontroldefaultconfig_modifiedonbehalfby");
				this.SetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_customcontroldefaultconfig_modifiedonbehalfby", null, value);
