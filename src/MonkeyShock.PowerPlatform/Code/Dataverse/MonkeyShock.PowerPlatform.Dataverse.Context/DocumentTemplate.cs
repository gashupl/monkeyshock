...
namespace MonkeyShock.PowerPlatform.Dataverse.Context
{
	...
	public partial class DocumentTemplate : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_documenttemplatebase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_documenttemplatebase_createdby", null);
			}
		}
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_documenttemplatebase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_documenttemplatebase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_documenttemplatebase_createdonbehalfby");
				this.SetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_documenttemplatebase_createdonbehalfby", null, value);
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_documenttemplatebase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_documenttemplatebase_modifiedby", null);
			}
		}
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser lk_documenttemplatebase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_documenttemplatebase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_documenttemplatebase_modifiedonbehalfby");
				this.SetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.SystemUser>("lk_documenttemplatebase_modifiedonbehalfby", null, value);
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.Organization lk_documenttemplatebase_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.Organization>("lk_documenttemplatebase_organization", null);
			}
		}
