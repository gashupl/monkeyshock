...
namespace MonkeyShock.PowerPlatform.Dataverse.Context
{
	...
	public partial class LanguageLocale : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<MonkeyShock.PowerPlatform.Dataverse.Context.LanguageLocaleState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((MonkeyShock.PowerPlatform.Dataverse.Context.LanguageLocaleState)(System.Enum.ToObject(typeof(MonkeyShock.PowerPlatform.Dataverse.Context.LanguageLocaleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<MonkeyShock.PowerPlatform.Dataverse.Context.KnowledgeArticle> knowledgearticle_languagelocaleid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<MonkeyShock.PowerPlatform.Dataverse.Context.KnowledgeArticle>("knowledgearticle_languagelocaleid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticle_languagelocaleid");
				this.SetRelatedEntities<MonkeyShock.PowerPlatform.Dataverse.Context.KnowledgeArticle>("knowledgearticle_languagelocaleid", null, value);
		...
		public MonkeyShock.PowerPlatform.Dataverse.Context.Organization languagelocale_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<MonkeyShock.PowerPlatform.Dataverse.Context.Organization>("languagelocale_organization", null);
			}
		}
